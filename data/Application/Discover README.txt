Discover Data Export

The Discover category of your data export includes the pieces of content that you favorited in the Discover view, as well as
content recommendations that were generated for you based on watch history, wellbeing and physical activity.

Files included:
----------

Discover Favorites.csv

This includes the items that you marked as favorite in the Discover view.
   timestamp                       - Datetime of the moment the item was favorited
   id                              - Unique identifier of the item
   title                           - Name of the item
   bundle_id                       - Category of content in the Discover view that the item belongs to
   content_type                    - Content type of the item

----------

Discover Content Recommendations.csv
